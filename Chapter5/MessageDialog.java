...
{
  // 메시지 타입 식별자(identifier).
  public static final int NEW = 0; // 새 매세지 작성
  public static final int REPLY = 1; // 답장 메세지 작성
  public static final int FORWARD = 2; // 전달 메시지 작성
  ...
  // 대화상자가 취소 버튼을 클릭해서 닫혔는지 여부를 나타내느 플래그.
  ...
  // 메시지 필드를 확인(validation)하고 대화상자를 닫는다.
  ...
  public boolean display() {
    ...
    // 전송버튼과 취소 버튼 중 어떤 것에 의해 닫히는가르 ㄹ리턴
    return !cancelled;
  }

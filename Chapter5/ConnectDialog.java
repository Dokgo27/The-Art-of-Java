...
/* 이 클래스는 이메일 서버에 접속하기 위한 연결 설정 정보를
*  입력하게 해준다. */
public class ConnectDialog extends JDialog
{
  ...
  {
    // 모달: 사용자의 이목을 집중시키기 위한 그래픽 인터페이스 창
  ...
  // 연결 설정을 확인(validation)하고 대화상자를 닫음
  ...
  // 이메일 서버 타입 접근자 (accessor)
  public String getType() {
    return (String) typeComboBox.getSelectedItem();
  }

  // 이메일 서버 주소 접근자 (accessor)
  public String getServer() {
    return serverTextField.getText();
  }

  // 이메일 사용자 이름 접근자 (accessor)
